            ...
            <div class="main">
                ...
                ?>
                    ...
                    <div>
                        <label>性別</label>
                        <br>
                        <input type="radio" id="1" name="gender" value="1" <?php if(empty($_POST['gender'])) { if($row['gender']== "0" ){ echo 'checked';}} else{ if($_POST['gender']== "1" ){ echo 'checked';}}?> />
                        <label for="1">男</label>
                        ...
                        <input type="radio" id="3" name="gender" value="3" <?php if(empty($_POST['gender'])) { if($row['gender']== "3" ){ echo 'checked';}} else{ if($_POST['gender']== "3" ){ echo 'checked';}}?> />
